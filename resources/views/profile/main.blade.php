                    ...
                    <div class="w-full md:w-2/5 p-4 sm:p-6 lg:p-8 bg-white shadow-md">
                        ...
                        <div class="w-full p-8 mx-2 flex justify-center">
                            <img id="photo-preview"
                                ...
                                src="{{ old('photo', asset('storage/' . $user->photo)) }}" alt="Bordered avatar">
                        </div>
                        <input
                    ...
                    <div class="w-full md:w-3/5 p-8 bg-white lg:ml-4 shadow-md">
                        <div class="rounded  shadow p-6">
                            <div class="pb-4">
                                ...
                                <input id="name" name="name" class="border-1 rounded-r px-4 py-2 w-full"
                                    type="text" value="{{ old('name', $user->name) }}" />
                            </div>
                            <div class="pb-4">
                                <label for="about" class="font-semibold text-gray-700 block pb-1">Email</label>
                                <input id="email" name="email" class="border-1 rounded-r px-4 py-2 w-full"
                                    type="email" value="{{ old('email', $user->email) }}" disabled />
                            </div>
                            <div class="pb-4">
                                <label for="password" class="font-semibold text-gray-700 block pb-1">Password</label>
                                <input id="password" name="password" class="border-1 rounded-r px-4 py-2 w-full"
                                    type="password" placeholder="*******" />
                            </div>
                            <button type="submit"
                                class="text-white bg-gray-800 hover:bg-black focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none">Simpan
                                Perubahan</button>
                        </div>
                    </div>
                </div>
