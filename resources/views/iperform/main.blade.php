                            ...
                            <tr>
                                ...
                                <th scope="col"
                                    ...
                                    <a class="flex justify-between"
                                        href="{{ route('kinerja-intern.index', ['sort' => 'intern_id', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Nama
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('kinerja-intern.index', ['sort' => 'position', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Posisi
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('kinerja-intern.index', ['sort' => 'date', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Bulan, Tahun
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('kinerja-intern.index', ['sort' => 'result', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Capaian
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('kinerja-intern.index', ['sort' => 'description', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Justifikasi
                                    ...
                                    <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                            <div class="text-base font-semibold text-gray-900 dark:text-white">
                                                {{ $performance->intern->name }}</div>
                                            <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                                {{ $performance->intern->email }}</div>
                                        </div>
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $performance->intern->position->name }}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ \Carbon\Carbon::parse($performance->date)->format('F, Y') }}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $performance->target }}.00</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $performance->result }}</td>
                                    <td class="p-4 text-base font-normal text-gray-500 whitespace-nowrap dark:text-white">
                                        {{ $performance->description }}</td>
