                ...
                <form action="/users-list" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="name" id="name" class="shadow-sm bg-gray-50 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 @error('name') border border-red-500 text-red-900 placeholder-red-700 @enderror" placeholder="John Doe" required>
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                            <input type="email" name="email" id="email" class="shadow-sm bg-gray-50 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 @error('name') border border-red-500 text-red-900 placeholder-red-700 @enderror" placeholder="example@company.com" required>
                        </div>
                        <div class="col-span-6 sm:col-span-3">
