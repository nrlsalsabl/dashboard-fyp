<button type="button" data-modal-target="edit-data-modal-{{ $spend->id }}"
    data-modal-toggle="edit-data-modal-{{ $spend->id }}"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700">
                <button
                    ...
                    type="submit">Simapan Perubahan</button>
            </div>
            </form>
        </div>
    </div>
