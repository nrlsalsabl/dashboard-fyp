                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tr>
                                ...
                                <th scope="col"
                                    ...
                                    <a class="flex justify-between"
                                        href="{{ route('spendings.index', ['sort' => 'staff_id', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Nama
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('spendings.index', ['sort' => 'date', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Tanggal
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('spendings.index', ['sort' => 'requirement', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Kebutuhan
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('spendings.index', ['sort' => 'budget', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Budget
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('spendings.index', ['sort' => 'status', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Status
                            ...
                            @foreach ($tables as $spend)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700"
                                    ...
                                    <td class="flex items-center p-4 mr-8 space-x-6 whitespace-nowrap">
                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                            <div class="text-base font-semibold text-gray-900 dark:text-white">
                                                {{ $spend->staff->name }}</div>
                                            <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                                {{ $spend->staff->email }}</div>
                                        </div>
                                    </td>
                                    ...
                                    <td
                                        ...
                                        {{ $spend->requirement }}</td>
                                    <td class="p-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ 'Rp' . number_format($spend->budget, 2, ',', '.') }}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <img class="h-10 rounded-lg shadow-xl dark:shadow-gray-800"
                                            src="{{ asset('storage/' . $spend->proof) }}" alt="{{ $spend->name }}">
                                    </td>
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        @php
                                        ...
                                        @endphp
                                        <span
                                            class="text-xs font-medium me-2 px-2.5 py-0.5 rounded {{ $status_color[$spend->status] }}">{{ $spend->status }}</span>
                                    </td>
                        ...
                        <tfoot>
                            <tr class="font-semibold text-gray-900 dark:text-white">
                                ...
                                <td class="p-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ 'Rp' . number_format($tables->sum('budget'), 2, ',', '.') }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
