...
<body class="px-4 pb-10 sm:max-w-2xl mx-auto">
    ...
    @if (session()->has('error'))
        <div class="flex mt-4 mitems-center p-4 mb-4 text-sm text-pink-800 border border-pink-300 rounded-lg bg-pink-50 dark:bg-gray-800 dark:text-pink-400 dark:border-pink-800"
            role="alert">
    ...
    @if (session()->has('success'))
        ...
        <section class="bg-white dark:bg-gray-900 shadow dark:border rounded-lg dark:border-gray-700 my-8">
            <h2 class="text-xl font-bold text-[#e6edf3] bg-[#010409] px-6 py-4 rounded-t-lg">
                <img src="https://fypmedia.id/wp-content/themes/lmd-fypmedia/img/logo.png" class="h-6"
                    alt="FYP Logo" />
            </h2>
            <div class="py-8 px-6">
                ...
                <div class="flex flex-col">
                    ...
                    <div>
                        <a href="https://www.instagram.com/fypmedia.id" target="_blank" class="text-sm">@fypmedia.id
                        </a>
    ...
    @else
        ...
        <form action="/form/498c62cf2582c9ef765d1154b0a64032" method="POST" enctype="multipart/form-data"
            ...
            <section class="bg-white dark:bg-gray-900 shadow dark:border rounded-lg dark:border-gray-700 my-8">
                <div
                    class="text-xl font-bold text-[#e6edf3] bg-[#010409] px-6 py-4 flex items-center gap-2 rounded-t-lg">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <div class="relative max-w-sm">
                                ...
                                <input datepicker datepicker-autohide datepicker-format="yyyy-mm-dd" type="text"
                                    id="date" required value="{{ old('date') }}" name="date"
                        ...
                        <div class="sm:col-span-2">
                            <label for="engagement"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Engagement
                                Rate<span class="text-red-500">*</span></label>
                            <input type="number" step="0.1" min="0.0" name="engagement" id="engagement"
                            ...
                            <p id="helper-text-explanation" class="mt-2 text-sm text-gray-500 dark:text-gray-400">Cek
                                engagement rate kamu <a href="https://phlanx.com/engagement-calculator"
                                    target="_blank"
                                    class="font-medium text-blue-600 hover:underline dark:text-blue-500">di sini</a>.
                            </p>
                        </div>
                        <div class="w-full self-center">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">JPG, JPEG,
                                atau
                                PNG.</p>
                            @error('photo')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                        ...
                        <div class="w-full flex justify-center">
                            <img class="rounded-full w-32 h-32 object-cover" id="photo_preview"
                                src="{{ asset('storage/images/default-profile-picture.jpg') }}"
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                        ...
                        @foreach ($categories as $category)
                            <div class="flex items-center me-4">
                                <input id="category_id_{{ $category->id }}" @checked(in_array((string) $category->id, $oldCategories))
                ...
                <div class="py-8 px-6">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <input type="number" min="0" name="finstagram" id="finstagram" required
                                value="{{ old('finstagram') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="1000">
                            @error('finstagram')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" id="rate_igs" required data-currency="rate_igs"
                                    name="rate_igs_display" value="{{ old('rate_igs_display') }}"
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" id="rate_igf" required data-currency="rate_igf"
                                    name="rate_igf_display" value="{{ old('rate_igf_display') }}"
                                    class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="2.000.000">
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" id="rate_igr" required data-currency="rate_igr"
                                    name="rate_igr_display" value="{{ old('rate_igr_display') }}"
                                    class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="2.000.000">
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" id="rate_igl" required data-currency="rate_igl"
                                    name="rate_igl_display" value="{{ old('rate_igl_display') }}"
                                    class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="2.000.000">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        <div class="w-full">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" id="tiktok" required value="{{ old('tiktok') }}"
                                    name="tiktok"
                                    class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="fypmedia.id">
                            </div>
                        ...
                        <div class="w-full">
                            <label for="ftiktok"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah Followers
                                TikTok<span class="text-red-500">*</span></label>
                            <input type="number" min="0" name="ftiktok" id="ftiktok"
                                value="{{ old('ftiktok') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" id="rate_ttf" required data-currency="rate_ttf"
                                    name="rate_ttf_display" value="{{ old('rate_ttf_display') }}"
                                    class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="2.000.000">
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" id="rate_ttl" required data-currency="rate_ttl"
                                    name="rate_ttl_display" value="{{ old('rate_ttl_display') }}"
                                    class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="2.000.000">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        <div class="w-full">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" id="youtube" required value="{{ old('youtube') }}"
                                    name="youtube"
                                    class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="fypmedia.id">
                            </div>
                        ...
                        <div class="w-full">
                            <label for="syoutube"
                                ...
                                YouTube<span class="text-red-500">*</span></label>
                            <input type="number" min="0" name="syoutube" id="syoutube"
                                value="{{ old('syoutube') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="1000" required>
                            @error('syoutube')
                        ...
                        <div class="sm:col-span-2">
                            <label for="rate_yt"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Rate Card
                                YouTube<span class="text-red-500">*</span></label>
                            <div class="flex">
                                <span
                                    class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border rounded-e-0 border-gray-300 border-e-0 rounded-s-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                                ...
                                <input type="text" id="rate_yt" required data-currency="rate_yt"
                                    name="rate_yt_display" value="{{ old('rate_yt_display') }}"
                                    class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="2.000.000">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" id="rate_event" required data-currency="rate_event"
                                    name="rate_event_display" value="{{ old('rate_event_display') }}"
                                    class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="2.000.000">
                ...
                <div class="py-8 px-6">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <p class="text-sm">Exclusive Talent akan diprioritaskan untuk diajukan kepada brand dan
                                berhak
                            ...
                            <div class="flex items-center mb-4">
                                <input id="talent-exclusive-yes" type="radio" value="1"
                                    name="talent_exclusive" required @checked(old('talent_exclusive') == '1')
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="talent-exclusive-yes"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ya, saya bersedia
                                    (Of
                                    course)</label>
                            </div>
                            <div class="flex items-center mb-4">
                                <input id="talent-exclusive-no" type="radio" value="0"
                                    name="talent_exclusive" @checked(old('talent_exclusive') == '0')
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            ...
            <section class="bg-white dark:bg-gray-900 shadow dark:border rounded-lg dark:border-gray-700 my-8">
                ...
                <div class="py-8 px-6">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="sm:col-span-2">
                            <label for="staff_id" class="block mb-2 font-medium text-gray-900 dark:text-white">PIC
                                (Siapa
                            ...
                            <div class="relative" id="search_pic">
                                ...
                                <input type="search" @if (old('staff_id') == 'input_manual') disabled @endif
                                    name="staff_id_display" value="{{ old('staff_id_display') }}" id="staff_id"
                                    class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Cari PIC..." />
                                <div id="dropdown"
                                    class="absolute z-50 overflow-hidden w-full bg-white border border-gray-300 rounded-lg shadow-lg dark:bg-gray-700 dark:border-gray-600 mt-1 hidden">
                                </div>
                                ...
                                <div id="spinner" class="absolute right-10 top-4 hidden">
                                    <svg class="animate-spin h-5 w-5 text-blue-500" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path class="opacity-75" fill="currentColor"
                                            d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291l-3.707 3.707c-4.019-4.02-4.019-10.537 0-14.556L6 7.291a8.003 8.003 0 010 10.582z">
                                        </path>
                                    </svg>
                                </div>
                            </div>
            ...
            <section class="bg-white dark:bg-gray-900 shadow dark:border rounded-lg dark:border-gray-700 my-8">
                ...
                <div class="py-8 px-6">
                    ...
                    <div class="grid gap-4 sm:grid-cols-12 sm:gap-6">
                        ...
                        <div class="sm:col-span-full">
                            <label for="npwp"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NPWP15</label>
            ...
            <section class="bg-white dark:bg-gray-900 shadow dark:border rounded-lg dark:border-gray-700 my-8">
                ...
                <div class="py-8 px-6">
                    ...
                    <div class="grid gap-10 sm:grid-cols-2 sm:gap-8">
                        ...
                        <div class="sm:col-span-2">
                            <label for="phone" class="block mb-4 font-medium text-gray-900 dark:text-white">Apakah
                                Kamu
                                Tertarik Bergabung Menjadi Shopee Affiliate?<span class="text-red-500">*</span></label>

                            <div class="flex">
                                <div class="flex items-center me-6">
                                    <input id="shopee-affiliate-yes" type="radio" value="1"
                                        name="shopee_affiliate" required @checked(old('shopee_affiliate') == '1')
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="shopee-affiliate-yes"
                                        class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ya</label>
                                </div>
                                <div class="flex items-center me-6">
                                    <input id="shopee-affiliate-no" type="radio" value="0"
                                        name="shopee_affiliate" @checked(old('shopee_affiliate') == '0')
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="sm:col-span-2">
                            <label for="phone" class="block mb-4 font-medium text-gray-900 dark:text-white">Apakah
                                Kamu
                                Tertarik Untuk Dibantu Personal Branding / Jasa Digital Marketing Oleh Tim FYP
                                Media?<span class="text-red-500">*</span></label>

                            <div class="flex">
                                <div class="flex items-center me-6">
                                    <input id="tiktok-affiliate-yes" type="radio" value="1"
                                        name="tiktok_affiliate" required @checked(old('tiktok_affiliate') == '1')
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="tiktok-affiliate-yes"
                                        class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ya</label>
                                </div>
                                <div class="flex items-center me-6">
                                    <input id="tiktok-affiliate-no" type="radio" value="0"
                                        name="tiktok_affiliate" @checked(old('tiktok_affiliate') == '0')
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="flex">
                                <div class="flex items-center me-6">
                                    <input id="mcn-tiktok-yes" type="radio" value="1" name="mcn_tiktok"
                                        required @checked(old('mcn_tiktok') == '1')
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="mcn-tiktok-yes"
                                        class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ya</label>
                                </div>
                                <div class="flex items-center me-6">
                                    <input id="mcn-tiktok-no" type="radio" value="0" name="mcn_tiktok"
                                        @checked(old('mcn_tiktok') == '0')
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="sm:col-span-2">
                            <div class="flex items-center">
                                ...
                                <label for="statement" class="ms-2 text-sm text-gray-900 dark:text-gray-300">Saya
                                    menyatakan bahwa data yang saya isikan dalam formulir ini sudah benar.<span
                                        class="text-red-500">*</span></label>
                            </div>
                            @error('statement')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
    ...
    <script>
        $(document).ready(function() {
            ...
            function performSearch(query) {
                if (query.length >=
                    1) { // Perform search only if the input length is greater than and equal 2 characters
                    ...
                    $.ajax({
                        ...
                        .show(); // Clear previous results and show the dropdown
