<button type="button" data-modal-target="edit-data-modal-{{ $indicator->id }}"
    data-modal-toggle="edit-data-modal-{{ $indicator->id }}"
...
<div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
    id="edit-data-modal-{{ $indicator->id }}">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="number" step="0.01" name="result" id="result"
                                value="{{ old('result', $indicator->result) }}"
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <div class="relative">
                                ...
                                <input datepicker datepicker-autohide datepicker-format="yyyy-mm-dd" type="text"
                                    ...
                                    placeholder="Pilih tanggal" value="{{ $indicator->date }}" required>
                            </div>
                        </div>
                        <div class="col-span-6">
                            ...
                            <textarea id="description" name="description" rows="4"
                                ...
                                placeholder="Membuat dashboard.." required>{{ $indicator->description }}</textarea>
                        </div>
                    </div>
            </div>
            <!-- Modal footer -->
