<button type="button" data-modal-target="edit-user-modal-{{ $finance->id }}"
    data-modal-toggle="edit-user-modal-{{ $finance->id }}"
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <select id="underline_select" name="status"
                                ...
                                <option value="3" {{ $finance->status == 'gagal' ? 'selected' : '' }}>Gagal
                                </option>
                                <option value="1" {{ $finance->status == 'proses' ? 'selected' : '' }}>Proses
                                </option>
                                <option value="2" {{ $finance->status == 'selesai' ? 'selected' : '' }}>Selesai
                                </option>
                            </select>
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="link_project" id="link_project"
                                value="{{ old('link_project', $finance->link_project) }}"
