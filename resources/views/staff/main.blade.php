                            ...
                            <tr>
                                <th scope="col" class="p-4">
                                    <div class="flex items-center">
                                        <input id="select_all_ids" name="" aria-describedby="checkbox-1"
                                            type="checkbox"
                                ...
                                <th scope="col"
                                    ...
                                    <a class="flex justify-between"
                                        href="{{ route('staff.index', ['sort' => 'name', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Nama
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('staff.index', ['sort' => 'address', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Alamat
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('staff.index', ['sort' => 'position_id', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Posisi
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('staff.index', ['sort' => 'phone', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Nomor HP
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('staff.index', ['sort' => 'birth', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('staff.index', ['sort' => 'village_id', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Domisili
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('staff.index', ['sort' => 'status', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Status
                            ...
                            @foreach ($tables as $staff)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $staff->position->name }}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $staff->phone }}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $staff->place }}, {{ \Carbon\Carbon::parse($staff->birth)->format('d F Y') }}
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $staff->village?->province?->name ?? $staff->regency->name }}</td>
                                    <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $staff->instagram }}, {{ $staff->linkedin }}</td>
                                    <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                        @if ($staff->status == 1)
                                            <div
                                        ...
                                        @else
                                            <div
                                                class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 text-rose-500 bg-rose-200 dark:bg-gray-800">
