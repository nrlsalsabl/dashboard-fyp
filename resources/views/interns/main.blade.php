                            ...
                            <tr>
                                ...
                                <th scope="col"
                                    ...
                                    <a class="flex justify-between"
                                        href="{{ route('intern.index', ['sort' => 'name', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Nama
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('intern.index', ['sort' => 'address', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Alamat
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('intern.index', ['sort' => 'position_id', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Posisi
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('intern.index', ['sort' => 'phone', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Nomor HP
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('intern.index', ['sort' => 'birth', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('intern.index', ['sort' => 'village_id', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Domisili
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('intern.index', ['sort' => 'status', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Status
                            ...
                            @foreach ($tables as $intern)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700"
                                    ...
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $intern->position->name }}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $intern->phone }}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $intern->place }}, {{ \Carbon\Carbon::parse($intern->birth)->format('d F Y') }}
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $intern->village?->province?->name ?? $intern->regency->name }}</td>
                                    <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $intern->instagram }}, {{ $intern->linkedin }}</td>
                                    <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                        @if ($intern->status == 1)
                                            <div
                                        ...
                                        @else
                                            <div
                                                class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 text-rose-500 bg-rose-100/60 dark:bg-gray-800">
