                            ...
                            <tr>
                                ...
                                <th scope="col"
                                    ...
                                    <a class="flex justify-between"
                                        href="{{ route('brand.index', ['sort' => 'name', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Nama
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('brand.index', ['sort' => 'phone', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Nomor HP
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('brand.index', ['sort' => 'category', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Kategori
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('brand.index', ['sort' => 'staff_id', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        PIC
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('brand.index', ['sort' => 'account_name', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('brand.index', ['sort' => 'account_number', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        No Rekening
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('brand.index', ['sort' => 'bank_name', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Nama Bank
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('brand.index', ['sort' => 'npwp', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        NPWP
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('brand.index', ['sort' => 'nik', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        NIK
                                        @if (request('sort') == 'nik')
                                            @if (request('direction') == 'asc')
                                                ▲
                            ...
                            @foreach ($tables as $brand)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700"
                                    ...
                                    <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                        <img class="w-10 h-10 rounded-full" src="{{ asset('storage/' . $brand->photo) }}"
                                            alt="{{ $brand->name }}">
                                    ...
                                    <td class="p-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $brand->account_name }}</td>
                                    <td class="p-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $brand->account_number }}</td>
                                    <td class="p-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $brand->bank_name }}</td>
                                    <td class="p-4 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $brand->npwp }}</td>
