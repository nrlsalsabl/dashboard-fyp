<button type="button" data-modal-target="edit-data-modal-{{ $brand->id }}"
    data-modal-toggle="edit-data-modal-{{ $brand->id }}"
            ...
            <div class="p-6 space-y-6">
                <form action="/brand/{{ $brand->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <label for="phone"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomer Hp</label>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <button id="editDropdownSearchButton-{{ $brand->id }}"
                                data-dropdown-toggle="editDropdownSearch-{{ $brand->id }}"
                                class="inline-flex items-center justify-between bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                type="button">
                                Pilih Kategori
                            ...
                            <!-- Dropdown menu -->
                            <div id="editDropdownSearch-{{ $brand->id }}"
                                    ...
                                    @foreach ($categories as $category)
                                        <li>
                                            <div
                                                ...
                                                <input id="category_id-{{ $category->id }}" name="category_id[]"
                                                    type="checkbox" value="{{ $category->id }}"
                                                    {{ in_array($category->id, $brand->categories->pluck('id')->toArray()) ? 'checked' : '' }}
                        ...
                        <div class="col-span-6">
                            ...
                            <textarea id="address" name="address" rows="4"
                                ...
                                placeholder="Input Address" required>{{ old('address', $brand->address) }}</textarea>
                        </div>
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="text" name="account_name"
                                value="{{ old('account_name', $brand->account_name) }}"
                        ...
                        <div class="col-span-full sm:col-span-4">
                            ...
                            <input type="text" name="account_number"
                                value="{{ old('account_number', $brand->account_number) }}"
                        ...
                        <div class="col-span-full sm:col-span-2">
                            ...
                            <input type="text" name="bank_name" value="{{ old('bank_name', $brand->bank_name) }}"
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="text" name="npwp" value="{{ old('npwp', $brand->npwp) }}"
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="text" name="nik" value="{{ old('nik', $brand->nik) }}"
