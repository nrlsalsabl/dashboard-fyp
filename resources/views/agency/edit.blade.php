<button type="button" data-modal-target="edit-data-modal-{{ $agency->id }}"
    data-modal-toggle="edit-data-modal-{{ $agency->id }}"
                ...
                <form action="/agency/{{ $agency->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            <label for="name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Agency</label>
                            <input type="text" name="name" value="{{ old('name', $agency->name) }}" id="name"
                        ...
                        <div class="col-span-6">
                            ...
                            <textarea id="address" name="address" rows="4"
                                ...
                                placeholder="Masukkan Alamat">{{ old('address', $agency->address) }}</textarea>
                        </div>
                    </div>
            </div>
            <!-- Modal footer -->
