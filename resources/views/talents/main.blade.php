                            ...
                            <tr>
                                ...
                                <th scope="col"
                                    ...
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'name', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Nama
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'phone', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Nomor HP
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'date', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'village_id', 'direction' => request('sort') == 'village_id' && request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Domisili
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'category', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Kategori
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'engagement', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Engagement Rate
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'finstagram', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Instagram Followers
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'rate_igs', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'rate_igf', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Rate Instagram Feed
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'rate_igr', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'rate_igl', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Rate Instagram Live
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'ftiktok', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Tiktok Followers
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'rate_ttf', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Rate Tiktok Feed
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'rate_ttl', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Rate Tiktok Live
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'syoutube', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Youtube Subscribers
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'rate_yt', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Rate Youtube
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'rate_event', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'talent_exclusive', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Talent Exclusive
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'staff_id', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        PIC
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'account_name', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'account_number', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        No Rekening
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'bank_name', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Nama Bank
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'npwp', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        NPWP
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'nik', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        NIK
                                        @if (request('sort') == 'nik')
                                            @if (request('direction') == 'asc')
                                                ▲
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'shopee_affiliate', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Shopee Affiliate
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'tiktok_affiliate', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Personal Branding
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'mcn_tiktok', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        MCN Tiktok
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    <a class="flex justify-between"
                                        href="{{ route('talent.index', ['sort' => 'status', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc']) }}">
                                        Status
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @foreach ($tables as $talent)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <td class="w-4 p-4">
                                        <div class="flex items-center">
                                            <input id="" name="ids" aria-describedby="checkbox-1"
                                                type="checkbox"
                                    ...
                                    <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                        <img class="w-10 h-10 rounded-full"
                                            src="{{ asset('storage/' . $talent->photo) }}" alt="{{ $talent->name }}">
                                    ...
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $talent->phone }}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $talent->place }}, {{ \Carbon\Carbon::parse($talent->date)->format('d F Y') }}
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    ...
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $talent->engagement }}</td>
                                    <td
                                        class="flex items-center gap-2 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="">
                                    ...
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $talent->finstagram }}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ 'Rp' . (floor($talent->rate_igs) == $talent->rate_igs ? number_format($talent->rate_igs, 0, ',', '.') : number_format($talent->rate_igs, 2, ',', '.')) }}
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ 'Rp' . (floor($talent->rate_igf) == $talent->rate_igf ? number_format($talent->rate_igf, 0, ',', '.') : number_format($talent->rate_igf, 2, ',', '.')) }}
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ 'Rp' . (floor($talent->rate_igr) == $talent->rate_igr ? number_format($talent->rate_igr, 0, ',', '.') : number_format($talent->rate_igr, 2, ',', '.')) }}
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ 'Rp' . (floor($talent->rate_igl) == $talent->rate_igl ? number_format($talent->rate_igl, 0, ',', '.') : number_format($talent->rate_igl, 2, ',', '.')) }}
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $talent->ftiktok }}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ 'Rp' . (floor($talent->rate_ttf) == $talent->rate_ttf ? number_format($talent->rate_ttf, 0, ',', '.') : number_format($talent->rate_ttf, 2, ',', '.')) }}
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ 'Rp' . (floor($talent->rate_ttl) == $talent->rate_ttl ? number_format($talent->rate_ttl, 0, ',', '.') : number_format($talent->rate_ttl, 2, ',', '.')) }}
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $talent->syoutube }}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ 'Rp' . (floor($talent->rate_yt) == $talent->rate_yt ? number_format($talent->rate_yt, 0, ',', '.') : number_format($talent->rate_yt, 2, ',', '.')) }}
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ 'Rp' . (floor($talent->rate_event) == $talent->rate_event ? number_format($talent->rate_event, 0, ',', '.') : number_format($talent->rate_event, 2, ',', '.')) }}
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            function performSearch(query, element) {
                if (query.length >= 1) {
                    $(element).closest('.search_pic').find('.spinner').removeClass('hidden');
                    $.ajax({
                        url: '/getStaffs?name=' + query,
                        method: 'GET',
                        success: function(data) {
                            $(element).closest('.search_pic').find('.spinner').addClass('hidden');
                            var dropdown = $(element).closest('.search_pic').find('.dropdown');
                            dropdown.empty().removeClass('hidden').show();

                            if (data.length == 0) {
                                dropdown.append(
                                    `<div class="px-4 py-2 text-sm text-gray-900 dark:text-white italic">PIC "${query}" tidak ada.</div>`
                                );
                                return;
                            }
                            ...
                            data.forEach(function(item) {
                                dropdown.append(
                                    '<div class="dropdown-item cursor-pointer px-4 py-2 text-sm text-gray-900 hover:bg-gray-200 dark:text-white dark:hover:bg-gray-600" data-value="' +
                                    item.id + '" data-name="' + item.name + '">' + item
                                    .name + '</div>');
                            });
                            ...
                            dropdown.find('.dropdown-item').on('click', function() {
                                ...
                                picName = name;
                                $(element).val(name);
                                $(element).closest('.search_pic').find('input[name="staff_id"]')
                                    .val(value);
                                dropdown.hide();
                            });
                        },
                    ...
                    $(element).closest('.search_pic').find('.dropdown').hide();
                    $(element).closest('.search_pic').find('.spinner').addClass('hidden');
                }
            }
            ...
            $(document).on('input', '.staff_id', function() {
                var query = $(this).val();
                debouncedSearch(query, this);
            });

            $(document).on('click', function(event) {
                if (!$(event.target).closest('.search_pic').length) {
                    $('.search_pic').each(function() {
                        let currentPicName = $(this).find('.staff_id').val();
                        if (currentPicName == '') {
                            $(this).find('.staff_id').val('');
                            $(this).find('input[name="staff_id"]').val('');
                            picName = '';
                        } else {
                            $(this).find('.staff_id').val(picName);
                        }
